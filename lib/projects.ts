import { IReviewCardProps } from '@/components/card'
...
export const projects: IReviewCardProps[] = [
  {
    ...
    hasExpand: true,
    banner: '/assets/projects/pxn.png',
    link: 'https://www.cbx.one/',
    stacks: ['Angular v6', 'TypeScript', 'RxJS', 'GraphQL'],
    summary: 'This is a digital currency trading website',
    achievements: [
      '1. Complete the development of requirements on time and quality, and be responsible for projects and products',
